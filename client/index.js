...
const refreshTickets = async () => {
  ...
  const showEl = createElementFromString(
    `<div class="ticket card" style="width: 18rem;">
      <img src="${ticketImage}" class="card-img-top" alt="...">
      <div class="card-body">
        <h5 class="card-title">Ticket</h5>
        ...
        <button class="btn btn-primary">Election Result</button>
      </div>
    </div>`
  );
  showEl.onclick = buyTicket.bind(null, ticket);
  ticketsEl.appendChild(showEl);
};
